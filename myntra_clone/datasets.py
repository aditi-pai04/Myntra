...
class VITONDataset(data.Dataset):
    def __init__(self, opt):
        ...
        self.data_path = 'C:\\Users\\aditi\\OneDrive\\Desktop\\myntra\\prototype\\Myntra_hack\\myntra_clone\\datasets\\test'
        ...
        img_names = []
        c_names = []
        with open(r'C:/Users/aditi/OneDrive/Desktop/myntra/prototype/Myntra_hack/myntra_clone/datasets/test_pairs.txt', 'r') as f:
    ...
    def __getitem__(self, index):
        ...
        for key in self.c_names:
            ...
            c[key] = Image.open(os.path.join(self.data_path, 'cloth', c_name[key])).convert('RGB')
        ...
        with open(os.path.join(self.data_path, 'openpose-json', pose_name), 'r') as f:
